...
<header>
    ...
    <form action="depenses.php" method="GET">
        <div>
            <label for="message"> Quel montant avez vous dépensé ?  (en €)</label>
            <br>
            <textarea placeholder="Montant:" name="montant_depense_1"></textarea>
        </div>      
        <div>
        <button type="submit" class="github_button" id="valider_depense_2">Valider</button>
        </div>      
    </form>
</body>